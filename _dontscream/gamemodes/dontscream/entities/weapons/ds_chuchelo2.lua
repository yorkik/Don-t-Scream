...
SWEP.PrintName = LANG.Get('HUNTER')
SWEP.Author = "Fuzzy"
...
function SWEP:Initialize()
	...
	self.ActivityTranslate[ ACT_MP_STAND_IDLE ]					= ACT_HL2MP_RUN_ZOMBIE_FAST
	self.ActivityTranslate[ ACT_MP_WALK ]						= ACT_HL2MP_RUN_ZOMBIE_FAST
	self.ActivityTranslate[ ACT_MP_RUN ]						= ACT_HL2MP_RUN_ZOMBIE_FAST
